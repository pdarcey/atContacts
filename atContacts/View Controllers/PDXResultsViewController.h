...
@interface PDXResultsViewController : UIViewController <UITextFieldDelegate, PDXContactMakerDelegate, PDXTwitterCommunicatorDelegate, UIViewControllerTransitioningDelegate>
